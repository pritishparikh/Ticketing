...
{
    public class StoreSecurityService: IStoreSecurity
    {
        ...
        public StoreSecurityService(string _connectionString, string _radisCacheServerAddress = null)
        {
        ...
        public bool UpdatePassword(string EmailId, string Password)
        {
            ...
            try
            {
                conn.Open();
                cmd.Connection = conn;
                MySqlCommand cmd1 = new MySqlCommand("SP_UpdateStorePassword", conn);
                cmd1.CommandType = CommandType.StoredProcedure;
        ...
        public bool sendMailForChangePassword(SMTPDetails sMTPDetails, string emailId, string content, int TenantId)
        {
            ...
            {
                CommonService commonService = new CommonService();
                isSent = commonService.SendEmail(sMTPDetails, emailId, "EasyRewardz Store User Created", content, null, null, TenantId);
        ...
        private Authenticate SaveUserToken(Authenticate authenticate)
        {
            ...
            try
            {
                conn.Open();
                cmd.Connection = conn;
                MySqlCommand cmd1 = new MySqlCommand("SP_createStoreCurrentSession", conn);
                cmd1.CommandType = CommandType.StoredProcedure;
        ...
        public void Logout(string token_data)
        {
            ...
            try
            {
                conn.Open();
                cmd.Connection = conn;
                MySqlCommand cmd1 = new MySqlCommand("SP_LogoutStoreUser", conn);
                cmd1.CommandType = CommandType.StoredProcedure;
        ...
        public Authenticate validateUserEmailId(string EmailId)
        {
            ...
            try
            {
                conn.Open();
                cmd.Connection = conn;
                MySqlCommand cmd1 = new MySqlCommand("SP_valiedateStoreEmailId", conn);
                cmd1.CommandType = CommandType.StoredProcedure;
