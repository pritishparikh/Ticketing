            ...
            try
            {
                ...
                if (!String.IsNullOrEmpty(Message))
                {
                    try
                    {
                        ...
                        string apiResponse = CommonService.SendApiRequest(ClientAPIURL + "api/ChatbotBell/SendCampaign", apiReq);
                ...
                using (conn)
                {
                    ...
                    using (var dr = await cmd.ExecuteReaderAsync())
                    {
                        ...
                        if (!String.IsNullOrEmpty(Message))
                        {
                            ...
                            string apiResponse = CommonService.SendApiRequest(ClientAPIURL + "api/ChatbotBell/SendSMS", apiReq);
