...
namespace Easyrewardz_TicketSystem.Services
{
    public partial class CustomerChatService : ICustomerChat
    {
        ...
        ///  <param name="StoreCode"></param>
        /// <returns></returns>
        public async Task<List<CustomItemSearchWBResponseModel>> ChatItemDetailsSearchWB(int TenantID, string Programcode, string ClientAPIURL, string SearchText, string StoreCode)
        {
            ClientCustomGetItemOnSearchnew SearchItemRequest = new ClientCustomGetItemOnSearchnew();
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(ClientAPIResponse))
                {
                    ItemList = JsonConvert.DeserializeObject<List<CustomItemSearchWBResponseModel>>(ClientAPIResponse);
                }
