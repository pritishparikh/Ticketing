                        ...
                        else if (searchModel.ActiveTabId.Equals(3))// campaign mapping
                        {
                            foreach (DataRow dr in ds.Tables[0].Rows)
                            {
                                SearchStoreCampaignReportResponse obj = new SearchStoreCampaignReportResponse()
                                {
                                    ...
                                    CallReScheduledOn = dr["CallReScheduledOn"] == DBNull.Value ? string.Empty : Convert.ToString(dr["CallReScheduledOn"]),
                                    CallReScheduledTime = dr["CallReScheduledTime"] == DBNull.Value ? string.Empty : Convert.ToString(dr["CallReScheduledTime"]),
                                    CreatedBy = dr["CreatedBy"] == DBNull.Value ? 0 : Convert.ToInt32(dr["CreatedBy"]),
                                    CreatedByName = dr["CreatedByName"] == DBNull.Value ? string.Empty : Convert.ToString(dr["CreatedByName"]), 
                                    CreatedDate = dr["CreatedDate"] == DBNull.Value ? string.Empty : Convert.ToString(dr["CreatedDate"]),
                                    ...
                                    Action = dr["ActionTaken"] == DBNull.Value ? string.Empty : Convert.ToString(dr["ActionTaken"]),
                                    ActionDate = dr["ActionDate"] == DBNull.Value ? string.Empty : Convert.ToString(dr["ActionDate"]),
                                    ActionTime = dr["ActionTime"] == DBNull.Value ? string.Empty : Convert.ToString(dr["ActionTime"]),
                                }; 
