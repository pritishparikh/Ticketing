...
namespace Easyrewardz_TicketSystem.Services
{
    public class HSChatTicketingService : IHSChatTicketing
    {
                ...
                using (var reader = await cmd.ExecuteReaderAsync())
                {
                    ...
                    if (dt != null && dt.Rows.Count > 0)
                    {
                        ...
                        if (!IsTimeOutBell)
                        {
                                ...
                                Params.Add("Mobilenumber", customGetChatTickets.CustomerMobileNumber);
        ...
        /// <param name="programCode"></param>
        /// <returns></returns>
        public TicketsOnPageLoadResposne GetTicketsOnLoad(TicketsOnPageLoad ticketsOnPageLoad, int tenantID, int userMasterID, string programCode)
        {
            DataSet ds = new DataSet();
            MySqlCommand cmd = new MySqlCommand();
            TicketsOnPageLoadResposne ticketsOnPageLoadResposne = new TicketsOnPageLoadResposne();
            ticketsOnPageLoadResposne.lstGetChatTickets = new List<CustomGetChatTickets>();
            ...
            try
            {
                ...
                sqlcmd.Parameters.AddWithValue("Status_ID", ticketsOnPageLoad.statusID);
                ...
                sqlcmd.Parameters.AddWithValue("PageNo", ticketsOnPageLoad.PageNo);
                sqlcmd.Parameters.AddWithValue("PageSize", ticketsOnPageLoad.PageSize);
                MySqlDataAdapter da = new MySqlDataAdapter
                {
                ...
                if (ds != null && ds.Tables[0] != null)
                {
                    for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                    {
                        CustomGetChatTickets customGetChatTickets = new CustomGetChatTickets
                        {
                            ...
                            IsIconDisplay = ds.Tables[0].Rows[i]["IsIconDisplay"] == DBNull.Value ? false : Convert.ToBoolean(ds.Tables[0].Rows[i]["IsIconDisplay"]),
                            IsChatAllreadyActive = ds.Tables[0].Rows[i]["IsChatAllreadyActive"] == DBNull.Value ? false : Convert.ToBoolean(ds.Tables[0].Rows[i]["IsChatAllreadyActive"]),
                        };
                        lstGetChatTickets.Add(customGetChatTickets);
                    }

                    ticketsOnPageLoadResposne.lstGetChatTickets = lstGetChatTickets;
                }
                ...
                if (ds != null && ds.Tables[1] != null)
                {
                    ...
                    {
                        totalCount = ds.Tables[1].Rows[0]["TotalOrder"] == DBNull.Value ? 0 : Convert.ToInt32(ds.Tables[1].Rows[0]["TotalOrder"]);
                    }
                }

                ticketsOnPageLoadResposne.TotalCount = totalCount;
            }
            catch (Exception)
            {
                throw;
            ...
            return ticketsOnPageLoadResposne;
        }
        ...
        /// <returns></returns>
        public TicketsOnPageLoadResposne GetTicketsOnSearch(ChatTicketSearch searchModel)
        {
            DataSet ds = new DataSet();
            MySqlCommand cmd = new MySqlCommand();
            TicketsOnPageLoadResposne ticketsOnPageLoadResposne = new TicketsOnPageLoadResposne();
            ...
            try
            {
                ...
                sqlcmd.Parameters.AddWithValue("PageNo", searchModel.PageNo);
                sqlcmd.Parameters.AddWithValue("PageSize", searchModel.PageSize);
                MySqlDataAdapter da = new MySqlDataAdapter();
        ...
        /// <summary>
        /// GetTicketsByCustomerOnLoad
        /// </summary>
        /// <param name="ticketsOnPageLoad"></param>
        /// <param name="tenantID"></param>
        /// <param name="userMasterID"></param>
        /// <param name="programCode"></param>
        /// <returns></returns>
        public TicketsOnPageLoadResposne GetTicketsByCustomerOnLoad(TicketsOnPageLoad ticketsOnPageLoad, int tenantID, int userMasterID, string programCode)
        {
            DataSet ds = new DataSet();
            MySqlCommand cmd = new MySqlCommand();
            TicketsOnPageLoadResposne ticketsOnPageLoadResposne = new TicketsOnPageLoadResposne();
