...
{
    public class WebBotHttpClientService
    {
        private readonly HttpClient Client;
        private readonly ILogger<WebBotHttpClientService> _logger;

        private bool IsLog = false;


        public WebBotHttpClientService(HttpClient client, ILogger<WebBotHttpClientService> logger)
        {
