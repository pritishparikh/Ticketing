...
{
    public class PhygitalHttpClientService
    {
        private readonly HttpClient Client;
        private readonly ILogger<PhygitalHttpClientService> _logger;

        private bool IsLog = false;

        public PhygitalHttpClientService(HttpClient client, ILogger<PhygitalHttpClientService> logger)
        {
