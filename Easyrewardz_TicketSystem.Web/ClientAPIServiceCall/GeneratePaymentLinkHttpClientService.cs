...
{
    public class GeneratePaymentLinkHttpClientService
    {
        private readonly HttpClient Client;
        private readonly ILogger<GeneratePaymentLinkHttpClientService> _logger;

        private bool IsLog = false;

        public GeneratePaymentLinkHttpClientService(HttpClient client, ILogger<GeneratePaymentLinkHttpClientService> logger)
        {
        ...
        public async Task<string> SendApiRequest(string Url,string Request, string token = "")
        {
