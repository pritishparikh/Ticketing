...
{
    public class ChatbotBellHttpClientService
    {
        private readonly HttpClient Client;
        private readonly ILogger<ChatbotBellHttpClientService> _logger;

        private bool IsLog = false;

        public ChatbotBellHttpClientService(HttpClient client, ILogger<ChatbotBellHttpClientService> logger)
        {

            //client.BaseAddress = new Uri(_config["GetStoreCodeUrl"]);
