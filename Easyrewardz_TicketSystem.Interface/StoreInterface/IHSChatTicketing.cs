...
namespace Easyrewardz_TicketSystem.Interface
{
    public interface IHSChatTicketing
    {
        ...
        /// <returns></returns>
        TicketsOnPageLoadResposne GetTicketsOnLoad(TicketsOnPageLoad ticketsOnPageLoad, int tenantID, int userMasterID, string programCode);
        ...
        /// <param name="programCode"></param>
        /// <returns></returns>
         Task<GetChatTicketsByID> GetChatTicketsByID(int ticketID, int tenantID, int userMasterID, string programCode, string ClientAPIURL);
        ...
        /// <returns></returns>
        TicketsOnPageLoadResposne GetTicketsOnSearch(ChatTicketSearch searchModel);
        ...
        /// <param name="programCode"></param>
        /// <returns></returns>
        TicketsOnPageLoadResposne GetTicketsByCustomerOnLoad(TicketsOnPageLoad ticketsOnPageLoad, int tenantID, int userMasterID, string programCode);
