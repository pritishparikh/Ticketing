...
namespace Easyrewardz_TicketSystem.Interface
{
    public partial interface IHSOrder
    {
        ...
        /// <returns></returns>
        Task<ReturnShipmentDetails> CreateShipmentAWB(int orderID, string itemIDs, int tenantID, int userID,string clientAPIURL, string ProgramCode, int templateID, string PhygitalClientAPIURL);
       ...
       Task< List<ReturnShipmentDetails>> GetAWBInvoicenoDetails(int orderID, int tenantID, int userID);
        ...
        /// <returns></returns>
        Task<int> GenerateLink(SentPaymentLink sentPaymentLink, string clientAPIUrlForGenerateToken, string clientAPIUrlForGeneratePaymentLink, int tenantID, int userID, string programCode, string ClientAPIUrl, HSRequestGenerateToken hSRequestGenerateToken);
