...
namespace Easyrewardz_TicketSystem.Interface
{
    public interface IStoreUser
    {
        ...
        /// <param name="UserID"></param>
        /// <returns></returns>
        List<StoreUserListing> GetStoreReportUserList(int tenantID, string RegionID, string ZoneID, int UserID);
        ...
        List<StoreCodeModel> StoreListByBrand(int TenantID, int BrandID);
    }
}
