...
namespace Easyrewardz_TicketSystem.WebAPI.Provider
{
    public partial class HSOrderCaller
    {
        ...
        /// <returns></returns>
        public async Task<ReturnShipmentDetails> InsertShipmentAWB(IHSOrder order, int orderID, string itemIDs,int tenantID,int userID,string clientAPIURL,string ProgramCode, int templateID, string PhygitalClientAPIURL)
        {
            _OrderRepository = order;
            return await _OrderRepository.CreateShipmentAWB(orderID, itemIDs, tenantID, userID, clientAPIURL, ProgramCode, templateID, PhygitalClientAPIURL);
        }
        ...
        /// <returns></returns>
        public async Task<int> GeneratePaymentLink(IHSOrder order, SentPaymentLink sentPaymentLink, string clientAPIUrlForGenerateToken, string clientAPIUrlForGeneratePaymentLink, int tenantID, int userID, string programCode, string ClientAPIUrl, HSRequestGenerateToken hSRequestGenerateToken)
        {
            _OrderRepository = order;
