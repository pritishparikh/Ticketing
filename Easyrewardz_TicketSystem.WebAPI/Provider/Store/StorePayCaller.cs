...
namespace Easyrewardz_TicketSystem.WebAPI.Provider.Store
{
    public class StorePayCaller
    {
        ...
        /// <returns></returns>
        public async Task<string> GenerateStorePayLink(IStorePay storePay, int TenantID, string ProgramCode, int UserID,
        ...
        {
            _storePay = storePay;
            return await _storePay.GenerateStorePayLink(TenantID, ProgramCode, UserID, clientAPIUrlForGenerateToken, clientAPIUrlForGeneratePaymentLink, hSRequestGenerateToken);
        }
