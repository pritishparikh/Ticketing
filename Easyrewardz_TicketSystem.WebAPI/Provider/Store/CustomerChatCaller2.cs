...
namespace Easyrewardz_TicketSystem.WebAPI.Provider
{
    public partial class CustomerChatCaller
    {
        ...
        public async Task<List<CustomItemSearchWBResponseModel>> ChatItemDetailsSearchWB(ICustomerChat customerChat, int TenantID, string Programcode, string ClientAPIURL, string SearchText, string StoreCode)
        {
            _customerChat = customerChat;
