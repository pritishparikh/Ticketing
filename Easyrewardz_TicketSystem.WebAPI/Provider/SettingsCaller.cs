...
namespace Easyrewardz_TicketSystem.WebAPI.Provider
{
    public class SettingsCaller
    {
       ...
       /// <summary>
        ...
        public CRMRoleModel GetCRMRoleByUserID(ICRMRole CRM, int tenantID, int UserID)
        {
            _dCRMrole = CRM;
            return _dCRMrole.GetCRMRoleByUserID( tenantID,  UserID);
        ...
        public List<MailParameterModel> GetMailParameter(ITemplate Temp, int TenantID, int AlertID)
        {
            _Temp = Temp;
            return _Temp.GetMailParameter(TenantID, AlertID);
        }
        #endregion
       ...
       // / </summary>
        ...
        public bool SendReportMail(IReports Report, string EmailID, string FilePath, int TenantID, int UserMasterID)
        {
            _Reports = Report;
            return _Reports.SendReportMail(EmailID, FilePath, TenantID, UserMasterID);
        }
