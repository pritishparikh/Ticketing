    ...
    public class SubCategoryController : ControllerBase
    {
        ...
        public ResponseModel GetSubCategoryByCategoryID(int CategoryID, int TypeId = 0)
        {
            ...
            try
            {
                ...
                objSubCategory = newMasterSubCat.GetSubCategoryByCategoryID(new SubCategoryService(Cache, Db), CategoryID, TypeId);
        ...
        public ResponseModel AddSubCategory(int categoryID,string SubcategoryName )
        {
            ...
            try
            {
                ...
                result = newMasterCategory.AddSubCategory(new SubCategoryService(Cache, Db), categoryID, SubcategoryName, authenticate.TenantId, authenticate.UserMasterID);
                statusCode =
               result == 0 ?
                      (int)EnumMaster.StatusCode.RecordNotFound : (int)EnumMaster.StatusCode.Success;
                statusMessage = CommonFunction.GetEnumDescription((EnumMaster.StatusCode)statusCode);
