    ...
    public partial class CustomerChatController : ControllerBase
    {
        ...
        public ResponseModel GetAgentList()
        {
            ...
            try
            {
                ...
                AgentList = customerChatCaller.GetAgentList(new CustomerChatService(_connectionString),authenticate.TenantId, authenticate.UserMasterID);
        ...
        public ResponseModel EndCustomerChat(int ChatID, string EndChatMessage)
        {
            ...
            try
            {
                ...
                result = customerChatCaller.EndCustomerChat(new CustomerChatService(_connectionString), authenticate.TenantId,
