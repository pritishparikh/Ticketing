...
namespace Easyrewardz_TicketSystem.WebAPI.Areas.Store.Controllers
{
    ...
    public class HSChatTicketingController : ControllerBase
    {
        ...
        private static string _getCustomerLastUpdatedTime;
        private readonly ChatbotBellHttpClientService _chatbotBellHttpClientService;
        #endregion

        #region Constructor
        public HSChatTicketingController(IConfiguration iConfig, ChatbotBellHttpClientService chatbotBellHttpClientService)
        {
        ...
        public ResponseModel GetTicketsOnPageLoad([FromBody]TicketsOnPageLoad ticketsOnPageLoad)
        {
            TicketsOnPageLoadResposne customGetChatTickets = new TicketsOnPageLoadResposne();
            ...
            try
            {
                ...
                customGetChatTickets = chatTicketingCaller.GetTicketsOnLoad(new HSChatTicketingService(_connectioSting), ticketsOnPageLoad, authenticate.TenantId, authenticate.UserMasterID,authenticate.ProgramCode);

                statusCode = customGetChatTickets.lstGetChatTickets.Count.Equals(0) ? (int)EnumMaster.StatusCode.RecordNotFound : (int)EnumMaster.StatusCode.Success;

                statusMessage = CommonFunction.GetEnumDescription((EnumMaster.StatusCode)statusCode);
                objResponseModel.Status = true;
                objResponseModel.StatusCode = statusCode;
                objResponseModel.Message = statusMessage;
                objResponseModel.ResponseData = customGetChatTickets.lstGetChatTickets.Count > 0 ? customGetChatTickets : null;
            }
            catch (Exception)
            {
                throw;
        ...
        public async Task<ResponseModel> GetChatTicketsByID(int ticketID)
        {
            ...
            try
            {
                ...
                _ClientAPIUrl = _ClientAPIUrl + _getCustomerLastUpdatedTime;

                customGetChatTickets = await chatTicketingCaller.GetTicketsByID(new HSChatTicketingService(_connectioSting, _chatbotBellHttpClientService),
                    ticketID, authenticate.TenantId, authenticate.UserMasterID, authenticate.ProgramCode,_ClientAPIUrl);
        ...
        {
            TicketsOnPageLoadResposne searchResultList = new TicketsOnPageLoadResposne();
            ResponseModel objResponseModel = new ResponseModel();
            int statusCode = 0;
            string statusMessage = "";
            HSChatTicketingCaller chatTicketingCaller = new HSChatTicketingCaller();
            try
            {
                ...
                statusCode = searchResultList.lstGetChatTickets.Count.Equals(0) ? (int)EnumMaster.StatusCode.RecordNotFound : (int)EnumMaster.StatusCode.Success;
                statusMessage = CommonFunction.GetEnumDescription((EnumMaster.StatusCode)statusCode);
                objResponseModel.Status = true;
                objResponseModel.StatusCode = statusCode;
                objResponseModel.Message = statusMessage;
                objResponseModel.ResponseData = searchResultList.lstGetChatTickets.Count > 0 ? searchResultList : null;
            }
            catch (Exception)
            {
                throw;
        ...
        public ResponseModel GetChatTicketsByCustomer([FromBody]TicketsOnPageLoad ticketsOnPageLoad)
        {
            TicketsOnPageLoadResposne customGetChatTickets = new TicketsOnPageLoadResposne();
            ResponseModel objResponseModel = new ResponseModel();
            int statusCode = 0;
            ...
            try
            {
                ...
                customGetChatTickets = chatTicketingCaller.GetTicketsByCustomerOnLoad(new HSChatTicketingService(_connectioSting), ticketsOnPageLoad, authenticate.TenantId, authenticate.UserMasterID, authenticate.ProgramCode);
