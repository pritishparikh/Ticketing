    ...
    public partial class StoreCampaignController : ControllerBase
    {
        ...
        public async Task<ResponseModel> GetCustomerpopupDetails(string mobileNumber, string campaignID)
        {
            ...
            try
            {
                ...
                objStoreCampaign = await storecampaigncaller.GetCustomerpopupDetailsList(new StoreCampaignService(_connectioSting, _chatbotBellHttpClientService), mobileNumber, authenticate.ProgramCode, campaignID, authenticate.TenantId, authenticate.UserMasterID, ClientAPIURL);
                statusCode =
        ...
        public async Task<ResponseModel> GetStoreCampaignKeyInsight(string mobileNumber, string campaignID, string lifetimeValue = null, string VisitCount = null)
        {
            ...
            try
            {
                ...
                KeyInsight = await storecampaigncaller.GetStoreCampaignKeyInsight(new StoreCampaignService(_connectioSting, _chatbotBellHttpClientService),  
        ...
        public async Task<ResponseModel> GetStoreCampaignLastTransactionDetails(string mobileNumber)
        {
            ...
            try
            {
                ...
                objLastTransactionDetails = await storecampaigncaller.GetStoreCampaignLastTransactionDetails(new StoreCampaignService(_connectioSting, _chatbotBellHttpClientService), 
