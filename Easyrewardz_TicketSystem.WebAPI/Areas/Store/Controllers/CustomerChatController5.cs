    ...
    public partial class CustomerChatController : ControllerBase
    {
        ...
        public ResponseModel saveReInitiateChat([FromBody]  CustomerChatMaster customerChatMaster)
        {
            ...
            try
            {
                ...
                result = customerChatCaller.SaveReInitiateChat(new CustomerChatService(_connectionString),authenticate.TenantId,authenticate.ProgramCode, _ClientAPIUrl, customerChatMaster);
