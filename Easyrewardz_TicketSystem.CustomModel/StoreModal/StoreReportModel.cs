...
namespace Easyrewardz_TicketSystem.CustomModel.StoreModal
{
    public class StoreReportModel
    {
        ...
        public string CampaignRegion { get; set; }
        public string CampaignZone { get; set; }
        //ends here
    ...
    public class SearchStoreCampaignReportResponse
    {
        ...
        public string CallReScheduledOn { get; set; }
        public string CallReScheduledTime { get; set; }
        public int CreatedBy { get; set; }
        public string CreatedByName { get; set; }
        public string CreatedDate { get; set; }
